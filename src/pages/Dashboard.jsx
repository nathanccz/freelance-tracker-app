    ...
    return (
        <div className='flex'> 
            <AppwriteContextProvider>
                ...
                {route === 'leads' && <Leads setActiveRoute={setActiveRoute} setProjectView={setProjectView}/>}
                {route === 'active' && <ActiveClients setActiveRoute={setActiveRoute} setProjectView={setProjectView}/>}
                ...
                {route === 'project' && <ProjectHome setActiveRoute={setActiveRoute} projectView={projectView}/>}
            </AppwriteContextProvider>
        </div>
    )
}